...
public class SortArray {
    ...
    public List<int[]> efficientSort(boolean intermediate) {
        ...
        int[] arr=array.clone();
        QuickSort(arr,0,arr.length-1,intermediate,steps);
        return steps;
    }
    ...
    public void QuickSort(int[] OriginalArray, int start, int end,boolean intermediate,List<int []>steps) {
        if (start < end) {
            int pivot = quick_sort(OriginalArray, start, end,intermediate,steps);
            QuickSort(OriginalArray, start, pivot - 1,intermediate,steps);
            QuickSort(OriginalArray, pivot + 1, end,intermediate,steps);
        }
    }
}